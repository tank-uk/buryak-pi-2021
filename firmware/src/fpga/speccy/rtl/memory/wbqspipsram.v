////////////////////////////////////////////////////////////////////////////////
//
// Filename: 	wbspipsram.v
// {{{
// Project:	A Set of Wishbone Controlled QSPI OSRAM Controllers
//
// Purpose:	Access a Quad SPI PSRAM via a WISHBONE interface.  This
//		includes both read and write commands to the SPI
//		PSRAM.  All read/write commands are accomplished using the
...
//
// Modified by: Andy Karpov (c) 2021
//
////////////////////////////////////////////////////////////////////////////////
// }}}
...
//
// ESP-PSRAM64 commands 
`define CMD_READ 					8'h03
`define CMD_FAST_READ 			8'h0B
`define CMD_FAST_READ_QUAD 	8'hEB
`define CMD_WRITE 				8'h02
`define CMD_WRITE_QUAD			8'h38
`define CMD_ENTER_QUAD_MODE 	8'h35
`define CMD_EXIT_QUAD_MODE 	8'hF5
`define CMD_RESET_ENABLE		8'h66
`define CMD_RESET 				8'h99
`define CMD_SET_BURST_LEN		8'hC0
`define CMD_READ_ID 				8'h9F

// TODO: 
// 1. remove erase functionality
// 2. change read / write commands
// 3. replace all hardcoded commands to defined ones
...
module	wbqspipsram #(
		...
		input	wire		i_wb_cyc, i_wb_data_stb, i_wb_ctrl_stb,
					i_wb_we,
	...
	begin
		...
		begin
			...
			2'b00: begin // Erase command register
				...
				// }}}
			2'b01: begin // Write the configuration register
				// {{{
				o_wb_ack <= 1'b1;
				o_wb_stall <= 1'b1;
				...
				// }}}
			2'b10: begin // Write the status register
				// {{{
